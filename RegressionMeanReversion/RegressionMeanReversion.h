...
private:
    ...
    int window_size; // number of bars to use for regression
    double previous_prediction; // previous predicted value
    int inventory_liquidation_increment; // % decrease in inventory
    int inventory_liquidation_interval; // time interval between inventory liquidation
    int bar_interval; // bar interval
